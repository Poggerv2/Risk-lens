...
def fetch_binance_data(symbol='BTCUSDT', interval=Client.KLINE_INTERVAL_1DAY, start_date="2019-01-01", end_date="2024-12-31"):
...
if __name__ == "__main__":
    btc_data = fetch_binance_data(start_date="2019-01-01", end_date="2024-12-31")
